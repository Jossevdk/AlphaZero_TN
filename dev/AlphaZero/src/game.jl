...
# =========================================
"""
    GetGraph(::AbstractGameSpec, state) :: FeaturedGraph
...
function features_dim(game_spec::AbstractGameSpec)
  fg = GetGraph(game_spec, current_state(init(game_spec)))
  return size(fg.nf.signal, 1)
end
